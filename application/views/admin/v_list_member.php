            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Member Of Townfolk Jurnalist</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <tbody>
                      ...
                      <tr>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <form action="<?php echo base_url();?>admin/set_status_member" method="post">
                        ...
                        <td><div class="col-xs-4 pull-left">
                                <a href="<?php echo base_url()?>admin/edit_member/<?php echo $data->id_user;?>"><button class="btn btn-warning btn-sm">
                            ...
                            <div class="col-xs-8 pull-right">
                                <button class="btn btn-danger btn-sm" onclick="delete_member('<?php echo $data->nama_depan; echo " ".$data->nama_belakang;?>','<?php echo $data->id_user;?>');">
